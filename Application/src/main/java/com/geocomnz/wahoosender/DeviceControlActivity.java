...
public class DeviceControlActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intentFilter.addAction("com.geocomnz.wahoosender");
    ...
    public class NotificationListener extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            String mypayload = notification.getString("mypayload");
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        new Timer().schedule(new TimerTask() {
            @Override
            public void run() {
                mBluetoothLeService.setmtu(512);
            }
        }, 2000);
    ...
    public void sendString(String from, String message) throws UnsupportedEncodingException {
        ...
        if (hex.length() == 1){
            ...
            asciiLength = hexToASCII(hex);
        }



        mBluetoothLeService.writeCharacteristic(smsGatt, (premessage + asciiLength + jsonMessage));
